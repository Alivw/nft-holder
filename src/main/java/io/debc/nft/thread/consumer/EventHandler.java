package io.debc.nft.thread.consumer;

import io.debc.nft.thread.contract.Contract;
import io.debc.nft.thread.contract.Erc20Contract;
import io.debc.nft.thread.entity.EsBalance;
import io.debc.nft.thread.entity.EsContract;
import io.debc.nft.thread.thread.Pool;
import io.debc.nft.thread.utils.Assert;
import io.debc.nft.thread.utils.CollectionUtils;
...
public class EventHandler {
    static Set<Contract> CONTRACTS = SysUtils.componentScan("io.debc.balance.contract", io.debc.nft.thread.annotation.Contract.class);

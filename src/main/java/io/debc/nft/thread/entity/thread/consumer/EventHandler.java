package io.debc.nft.thread.entity.thread.consumer;

import io.debc.nft.thread.entity.thread.contract.Contract;
import io.debc.nft.thread.entity.thread.contract.Erc20Contract;
import io.debc.nft.thread.entity.thread.entity.EsBalance;
import io.debc.nft.thread.entity.thread.entity.EsContract;
import io.debc.nft.thread.entity.thread.thread.Pool;
import io.debc.nft.thread.entity.thread.utils.Assert;
import io.debc.nft.thread.entity.thread.utils.CollectionUtils;
import io.debc.nft.thread.entity.thread.utils.EsQueryUtils;
import io.debc.nft.thread.entity.thread.utils.SysUtils;
...
public class EventHandler {
    static Set<Contract> CONTRACTS = SysUtils.componentScan("io.debc.balance.contract", io.debc.nft.thread.entity.thread.annotation.Contract.class);

package io.debc.nft.thread.entity.consumer;

import io.debc.nft.thread.entity.contract.Contract;
import io.debc.nft.thread.entity.contract.Erc20Contract;
...
import io.debc.nft.thread.entity.utils.Assert;
import io.debc.nft.thread.entity.utils.CollectionUtils;
import io.debc.nft.thread.entity.utils.EsQueryUtils;
...
public class EventHandler {
    static Set<Contract> CONTRACTS = SysUtils.componentScan("io.debc.balance.contract", io.debc.nft.thread.entity.annotation.Contract.class);
